...
static AnimationDefinition particle_transparent(33, 62, true, 0);
static AnimationDefinition particle_white(2, 31, true, 0);
static AnimationDefinition snowflake_white(64, 93, true, 0);
static AnimationDefinition snowflake_transparent(95, 124, true, 0);
static AnimationDefinition disc_white(126, 155, true, 0);
...
void Particle::initAnimation(Particle::Type type)
{
    ...
    case Particle::Type::RotatingParticleTransparent:
        animation.startRandom(particle_transparent);
        break;
    case Particle::Type::RotatingParticleWhite:
        animation.startRandom(particle_white);
        break;
    case Particle::Type::RotatingSnowflakeTransparent:
        animation.startRandom(snowflake_transparent);
        break;
    case Particle::Type::RotatingSnowflakeWhite:
        animation.startRandom(snowflake_white);
        break;
    case Particle::Type::RotatingCylinder:
        animation.startRandom(disc_white);
        break;
