...
void Background::draw(GPUBatcher& batcher, const ppl7::grafix::Rect& viewport, const ppl7::grafix::Point& WorldCoords)
{
#ifdef TODO
    if (t == Type::Color) {
...
void Background::drawFade(SDL_Renderer* renderer, const ppl7::grafix::Rect& viewport, const ppl7::grafix::Point& WorldCoords)
{
    ...
    if (fade_target_type == Type::Color) {
        SDL_SetRenderDrawColor(renderer, fade_target_color.red(), fade_target_color.green(), fade_target_color.blue(),
                               (Uint8)(255.0f * fade_progress));
