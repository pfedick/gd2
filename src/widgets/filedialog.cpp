...
FileDialog::FileDialog(ppltk::Window *parent, int width, int height, FileMode mode)
    : Dialog(parent, width, height, Dialog::None)
{
    ...
    cancel_button = new ppltk::Button(clientarea.width - 220, clientarea.height - 30, 200, 30, translate("Cancel"),
                                      wm->Toolbar.getDrawable(25));
    ...
    path_lineinput =
        new ppltk::LineInput(10 + text_size.width + 10, 0, clientarea.width - 30 - text_size.width, 30, path);
    ...
    this->addChild(label);
    filename_lineinput = new ppltk::LineInput(20 + text_size.width, clientarea.height - 80,
                                              clientarea.width - text_size.width - 30 - 300, 30);
