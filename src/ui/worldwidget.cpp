...
void OxygenFrame::paint(ppl7::grafix::Drawable& draw)
{
    ...
    if (seconds_left < 15 && seconds_left >= 8) {
        ...
        oxygen = ppl7::grafix::Color::getBlended(ppl7::grafix::Color(255, 192, 0, 192), oxygen, blend);
    } else if (seconds_left < 8 && seconds_left >= 3) {
        int blend = (seconds_left - 3.0f) * 255 / 5;
        oxygen = ppl7::grafix::Color::getBlended(ppl7::grafix::Color(255, 0, 0, 192), ppl7::grafix::Color(255, 192, 0, 192), blend);
